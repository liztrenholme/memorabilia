    ...
    return (
      <div className="App">
        ...
        <nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
            <a className="navbar-brand" href="#"><img src="assets/images/logo.jpg" width="80px" /></a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav mr-auto">
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link dropdown-toggle scrollable-menu" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Categories</a>
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="http://kollectingkiss.tumblr.com/"><img src="assets/images/tumblr.png" width="24px" height="24px" /></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="http://twitter.com/KollectingKiss"><img src="assets/images/twitter-48.png" width="24px" height="24px" /></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href=" http://kollectingkiss.blogspot.com/"><img src="assets/images/blogger-5-48.png" width="24px" height="24px" /></a>
                    </li>
                </ul>
        ...
        <div className="container">
            <div className="row">
                <div className="col-md-12">
                    <img id="header" src="assets/images/header.jpg" />
                </div>
            </div>
            <div className="row">
                ...
                <div className="col-md-10">
                    <div className="row">
                        <div id="main">
                            ...
                            <p id="disclaimer">(Please note we are NOT a retail site. We are for informational purposes only!)</p>
